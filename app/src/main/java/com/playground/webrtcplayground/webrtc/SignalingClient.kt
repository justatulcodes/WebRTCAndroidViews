...
package com.playground.webrtcplayground.webrtc

import android.util.Log
import com.playground.webrtcplayground.BuildConfig
...
class SignalingClient {
  ...
  init {
    Log.d("SignalingClient", "Initializing with URL: ${BuildConfig.SIGNALING_SERVER_IP_ADDRESS}")
  }
  ...
  private inner class SignalingWebSocketListener : WebSocketListener() {
    ...
    override fun onFailure(webSocket: WebSocket, t: Throwable, response: okhttp3.Response?) {
      Log.e("SignalingClient", "WebSocket connection failed", t)
    }
...
enum class WebRTCSessionState {
  ...
  HungUp // when remote user has disconnected
}
...
enum class SignalingCommand {
  ...
  HANGUP // to indicate that user has disconnected
}
